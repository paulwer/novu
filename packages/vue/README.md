# Novu's Vue SDK for building custom inbox notification experiences.

Novu provides the `@novu/vue` a Vue library that helps to add a fully functioning Inbox to your web application in minutes. Let's do a quick recap on how you can easily use it in your application.
See full documentation [here](https://docs.novu.co/inbox/vue/get-started).

## Installation

- Install `@novu/vue` npm package in your vue app
  ...
  return (
    <div>
      <Inbox
        ...
        v-model:open="isOpen"
      />
      <button @click="open = true">Open Inbox</button>
      <button @click="open = false">Close Inbox</button>
    </div>
  );
}
```
...
<Frame caption="How to enable HMAC encryption for In-App Inbox">
  <img src="/images/notification-center/client/vue/get-started/hmac-encryption-enable.png" />
</Frame>
